...
print(booking);
    setState(() {
      ...
      numberChildren = booking.getBuses.numberOfChildren.toString();
                                    ...
                                    onTap: () {
                                      ...
                                      setState(() {
                                        numberAdult = booking
                                            ...
                                            .toString();
                                        adultController.text = numberAdult;
                                      });
                                    }),
                                Expanded(
                                  child: Container(
                                        ...
                                        if (value.isNotEmpty) {
                                          setState(() {
                                            if (int.parse(value) <= 2) {
                                              ...
                                              // booking.getBuses.numberOfAdults =
                                              //     int.parse(numberChildren);
                                            } else {
                                              Dialogs.showWelcomeSnackBar(
                                                  'Sorry!',
                                                  'You can not add more than 2 children.');
                                              numberChildren = '2';
                                            }
                                          });
                                        }
